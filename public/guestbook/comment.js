...
const s_stylePath = '/public/guestbook/comment.css'; // Define the path for the stylesheet (ie. /styles/commentwidget.css)
const s_formId = '1FAIpQLSe_ApUerIMN0CpaMj-hCKET6pJJTrRIQWR6-yksuUqBJH8Jzw'; // The Google Form
const s_nameId = '1995468964'; // The Name field ID
const s_websiteId = '47161548'; // The Website field ID
const s_textId = '1371305806'; // The Text field ID
const s_pageId = '1240735320'; // The Page field ID
const s_replyId = '198133630'; // The Reply field ID
const s_sheetId = '16JZ9QTbHDClv79BT8T2t2SWxaUTP_BSIuLHpSa20q2E'; // The Google Sheet
...
const s_maxLength = 600; // The max character length of a comment
...
const s_filteredWords = [ // Add words to filter by putting them in quotes and separating with commas (ie. 'heck', 'dang')
    'nigger', 'nigga', 'tranny', 'fag', 'faggot'
]
...
const s_textFieldLabel = 'I&#39;d like to know what you have to say!';
